      ...
      <div className="mt-6 relative">
        ...
        <div className="flex items-end space-x-2 h-64 overflow-x-auto pb-4">
          {revenueData.map((item, index) => (
            <div key={index} className="flex flex-col items-center flex-shrink-0" style={{ width: '60px' }}>
              <div className="relative w-12 mb-2" style={{ height: `${(item.revenue / maxRevenue) * 100}%` }}>
                <div className="absolute bottom-0 w-full bg-purple-500 rounded-t-md" style={{ height: `${(item.revenue / maxRevenue) * 100}%` }}></div>
                <div className="absolute bottom-0 w-full bg-gray-300 rounded-t-md" style={{ height: `${(item.lastYear / maxRevenue) * 100}%`, width: '40%', left: '30%' }}></div>
              </div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
            <h3 className="text-sm font-medium text-gray-500">{t('averageRevenue')}</h3>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
            <h3 className="text-sm font-medium text-gray-500">{t('highestMonth')}</h3>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
            <h3 className="text-sm font-medium text-gray-500">{t('lowestMonth')}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h2 className="text-3xl font-bold mt-2 text-gray-900">40,689</h2>
                <div className="flex items-center mt-2 text-green-500">
                  <ArrowUpRight className="w-4 h-4 mr-1" />
                  <span className="text-sm font-medium">+8.5% {t('fromYesterday')}</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-gray-500">{t('totalClinics')}</p>
                <h2 className="text-3xl font-bold mt-2 text-gray-900">10,293</h2>
                <div className="flex items-center mt-2 text-green-500">
                  <ArrowUpRight className="w-4 h-4 mr-1" />
                  <span className="text-sm font-medium">+1.3% {t('fromLastWeek')}</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h2 className="text-3xl font-bold mt-2 text-gray-900">$89,000</h2>
                <div className="flex items-center mt-2 text-red-500">
                  <ArrowDownRight className="w-4 h-4 mr-1" />
                  <span className="text-sm font-medium">-4.3% {t('fromYesterday')}</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-gray-500">{t('totalPending')}</p>
                <h2 className="text-3xl font-bold mt-2 text-gray-900">2,040</h2>
                <div className="flex items-center mt-2 text-green-500">
                  <ArrowUpRight className="w-4 h-4 mr-1" />
                  <span className="text-sm font-medium">+1.8% {t('fromYesterday')}</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <h2 className="text-lg font-semibold text-gray-900">{t('revenueDetails')}</h2>
              
              <div className="flex flex-wrap items-center mt-4 sm:mt-0 gap-3">
                <div className="flex items-center space-x-2 bg-gray-100 rounded-lg p-1">
                  <button 
                    className={`p-1.5 rounded-md text-xs font-medium ${chartType === 'bar' ? 'bg-white shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                    onClick={() => setChartType('bar')}
                  >
                    <BarChart3 className="w-4 h-4" />
                  </button>
                  <button 
                    className={`p-1.5 rounded-md text-xs font-medium ${chartType === 'line' ? 'bg-white shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                    onClick={() => setChartType('line')}
                  >
                    <LineChart className="w-4 h-4" />
                  </button>
                  <button 
                    className={`p-1.5 rounded-md text-xs font-medium ${chartType === 'pie' ? 'bg-white shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  ...
                  <span className="text-xs text-gray-700">{t('manageUsers')}</span>
                </button>
                <button className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <Building2 className="w-5 h-5 text-green-600 mb-2" />
                  <span className="text-xs text-gray-700">{t('manageClinics')}</span>
                </button>
                <button className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <Activity className="w-5 h-5 text-blue-600 mb-2" />
                  <span className="text-xs text-gray-700">{t('viewReports')}</span>
                </button>
                <button className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
        ...
        <div className="mt-8 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <h2 className="text-lg font-semibold text-gray-900">{t('approvalHistory')}</h2>
                  ...
                  <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="font-medium text-gray-900">{item.clinicName}</div>
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
            <div className="text-sm text-gray-500">
              {t('showing')} {indexOfFirstItem + 1} {t('to')} {Math.min(indexOfLastItem, approvalHistory.length)} {t('of')} {approvalHistory.length} {t('entries')}
            </div>
            <div className="flex items-center space-x-2">
              <button 
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                <button 
                  key={page}
                  className={`w-8 h-8 rounded-md ${currentPage === page ? 'bg-purple-600 text-white' : 'border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">{t('comparedToLastMonth')}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-medium text-gray-900">{t('clinicRegistrations')}</h3>
