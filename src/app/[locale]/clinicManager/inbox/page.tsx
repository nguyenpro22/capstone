            ...
            <div className="p-3 border-t bg-white flex items-center space-x-2">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className={`w-full border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                    isRecording ? "bg-red-50 text-red-600 border-red-200" : ""
                  }`}
