...
export default function ServicePage() {
  ...
  const [modalType, setModalType] = useState<"promotion" | "procedure" | null>(
    null
  );
        ...
        {services.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 text-center">
              ...
              <tbody>
                {services.map((service: Service, index: number) => (
                  ...
                  >
                    <td className="p-3 border border-gray-200 dark:border-gray-700 dark:text-gray-200 text-center">
                      {(pageIndex - 1) * pageSize + index + 1}
                    </td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700 font-medium dark:text-gray-100 text-center">
                      <div
                        className="max-w-[200px] truncate mx-auto"
                        title={service.name}
                      >
                        {service.name}
                      </div>
                    </td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700 text-center whitespace-nowrap">
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 dark:from-pink-300 dark:to-purple-300 font-medium">
                        ...
                        {service.maxPrice.toLocaleString()} VND
                      </span>
                    </td>
                        ...
                        {service.coverImage &&
                          service.coverImage.length > 1 && (
                            <button
                              ...
                              onClick={() =>
                                handleOpenModal(service.coverImage || [])
                              }
                            >
                    ...
                    <td className="p-3 border border-gray-200 dark:border-gray-700 text-center">
                      <div
                        className="max-w-[150px] truncate mx-auto"
