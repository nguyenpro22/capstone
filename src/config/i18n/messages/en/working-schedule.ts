...
export const workingScheduleMessages: Messages["workingSchedule"] = {
  ...
  undetermined: "Undetermined",
    ...
    selectShiftFirst: "Please select a shift first",
  shiftAppliedToMultipleDates: "Shift applied to all selected dates",
  shiftAppliedToDate: "Shift applied to date {date}",
  assignShiftsToAllDates: "Please assign shifts to all selected dates",
  bulkShiftAssignment: "Bulk Shift Assignment",
  bulkShiftAssignmentDescription: "Apply shifts to multiple dates at once",
  applyShiftToAllDates: "Apply shift to all selected dates",
  selectShiftForEachDate: "Select a shift for each date individually",
  selectShiftForMultipleDates: "Select Shift for Multiple Dates",
  selectShiftForDate: "Select Shift for {date}",
  selectShiftDescription: "Choose a shift to apply to the selected date(s)",
  loadingShifts: "Loading shifts...",
  errorLoadingShifts: "Error loading shifts. Please try again.",
