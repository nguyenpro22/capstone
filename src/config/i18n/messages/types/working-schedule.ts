export interface workingScheduleMessages {
  ...
  // Shift selection
  selectShiftFirst: string;
  shiftAppliedToMultipleDates: string;
  shiftAppliedToDate: string;
  assignShiftsToAllDates: string;
  bulkShiftAssignment: string;
  bulkShiftAssignmentDescription: string;
  applyShiftToAllDates: string;
  selectShiftForEachDate: string;
  selectShiftForMultipleDates: string;
  selectShiftForDate: string;
  selectShiftDescription: string;
  loadingShifts: string;
  errorLoadingShifts: string;
