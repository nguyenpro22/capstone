...
import { Clock, CreditCard, CheckCircle2, XCircle, FileText, Layers } from 'lucide-react'
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-base font-medium text-slate-800 dark:text-slate-200">{clinic.name}</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-300">{clinic.phoneNumber}</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-300">{clinic.address}</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-300">{clinic.taxCode}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs text-slate-500 dark:text-slate-400 mb-1">{t("operatingLicenseExpiryDate")}</div>
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-300">{clinic.totalBranches}</div>
                </div>
              </div>
            </div>
