...
export default function StaffForm({ onClose, onSaveSuccess }: StaffFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      firstName: "",
      lastName: "",
      roleType: 2, // Fixed to Doctor (1) as requested
      branchId: "",
    },
  })
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <input type="hidden" {...register("roleType")} value={1} />
