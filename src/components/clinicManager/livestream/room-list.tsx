// Thêm kiểu dữ liệu cho props và các biến
"use client";
...
interface LivestreamRoomListProps {
  filter?: string;
...
export default function LivestreamRoomList({
  filter = "all",
  categoryFilter,
  searchQuery = "",
  onJoinRoom,
}: LivestreamRoomListProps) {
        ...
        <div className="relative rounded-lg overflow-hidden bg-black aspect-video max-h-[400px]">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <Button
                onClick={() => joinRoom(previewRoom.id)}
