  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-black/30 backdrop-blur-sm overflow-y-auto">
      <motion.div
        ...
        className="max-w-2xl mx-auto p-6 bg-white/95 dark:bg-gray-900/95 backdrop-blur rounded-2xl shadow-2xl max-h-[80vh] overflow-y-auto relative"
      >
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center space-y-2 mb-6">
          <h2 className="text-xl font-serif tracking-wide text-gray-800 dark:text-gray-100">{t("branchDetails")}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
              ...
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("branchName")}</div>
                <div className="text-base font-medium text-gray-800 dark:text-gray-200">{viewBranch.name}</div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
              ...
              <div>
                ...
                <div className="text-gray-700 dark:text-gray-300">{viewBranch.email}</div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
              ...
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("phoneNumber")}</div>
                <div className="text-gray-700 dark:text-gray-300">{viewBranch.phoneNumber}</div>
              </div>
            </div>
            ...
            {"taxCode" in viewBranch && viewBranch.taxCode && (
              <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
                ...
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("taxCode")}</div>
                  <div className="text-gray-700 dark:text-gray-300">{viewBranch.taxCode as string}</div>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            {"fullAddress" in viewBranch && viewBranch.fullAddress && (
              <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
                ...
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("address")}</div>
                  <div className="text-gray-700 dark:text-gray-300">{viewBranch.fullAddress as string}</div>
                </div>
              </div>
            )}
            ...
            {(viewBranch.businessLicenseUrl || viewBranch.operatingLicenseUrl) && (
              <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
                <FileText className="w-5 h-5 text-pink-400 mt-1" />
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("licenses")}</div>
            ...
            {viewBranch.operatingLicenseExpiryDate && (
              <div className="flex items-start space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
                ...
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("operatingLicenseExpiryDate")}</div>
                  <div className="text-gray-700 dark:text-gray-300">
        ...
        {viewBranch.profilePictureUrl && (
          <div className="mt-4 p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl hover:bg-white/80 dark:hover:bg-gray-800/80 transition-colors duration-300">
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">{t("profilePicture")}</div>
