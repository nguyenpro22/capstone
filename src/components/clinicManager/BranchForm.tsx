...
export default function BranchForm({ onClose, onSaveSuccess }: BranchFormProps) {
  ...
  // Add state for the upgrade package popup
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error?.data?.detail) {
        ...
        // Check for the specific error message and show the upgrade popup
        if (error.data.detail === "You have reached the maximum number of branches") {
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    {validationErrors.city && (
                      <p className="text-red-500 dark:text-red-400 text-xs mt-1">{validationErrors.city}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {validationErrors.ward && (
                      <p className="text-red-500 dark:text-red-400 text-xs mt-1">{validationErrors.ward}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {validationErrors.address && (
                      <p className="text-red-500 dark:text-red-400 text-xs mt-1">{validationErrors.address}</p>
                    )}
                  </div>
                </div>
