            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="ml-4 flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <p
                      className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 break-all"
                      title={viewDoctor.email}
                    >
                      {viewDoctor.email}
                    </p>
                    <button
                      onClick={() => copyToClipboard(viewDoctor.email)}
                      className="p-1 hover:bg-purple-100 rounded-full transition-colors"
                      title={t("copyToClipboard") || "Copy to clipboard"}
                    >
                      <Copy className="w-3.5 h-3.5 text-purple-600" />
              ...
              {viewDoctor.phoneNumber && (
                ...
                >
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <p className="font-medium" title={viewDoctor.phoneNumber}>
                        {viewDoctor.phoneNumber}
                      </p>
                      <button
                        onClick={() =>
                ...
                >
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="flex items-start gap-2">
                      <p className="font-medium" title={viewDoctor.fullAddress}>
                        {viewDoctor.fullAddress}
                      </p>
                      <button
                        onClick={() => copyToClipboard(viewDoctor.fullAddress)}
                      ...
                      {viewDoctor.branchs.map((branch, idx) => (
                        <div key={idx} className="flex items-center">
                          ...
                          <button
                            ...
                            className="p-0.5 ml-0.5 hover:bg-blue-100 rounded-full transition-colors"
                            title={t("copyToClipboard") || "Copy to clipboard"}
                          >
